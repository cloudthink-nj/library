package com.ibroadlink.library.base.download
...
object DownLoadManager {
    private val retrofitBuilder by lazy {
        Retrofit.Builder()
                ...
                .client(
                        HttpRequest.INSTANCE.okHttpClient
                ).build()
    }
    ...
    suspend fun downLoad(
            ...
            loadListener: OnDownLoadListener? = null
    ) {
    ...
    private suspend fun doDownLoad(
        ...
        if (scope != null && scope.isActive) {
            ...
            LogUtils.i("key $tag 已经在队列中 但是已经不再活跃 remove")
        ...
        LogUtils.i("startDownLoad current $currentLength")
        ...
        try {
            ...
            if (responseBody == null) {
                LogUtils.i("responseBody is null")
                withContext(Dispatchers.Main) {
